...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tambah Soal Ujian Kelas {{ $levelsubject->level->kelas }}</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="/ujian/levelsubjectid={{ $levelsubject->id }}/periodid={{ $scoreratio->id }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-2">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a href="/ujian/levelsubjectid={{ $levelsubject->id }}/periodid={{ $scoreratio->id }}" class="btn btn-secondary" data-dismiss="modal">Kembali</a>

...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Soal Ujian Kelas {{ $level->kelas }}</h1>
    ...
    <section class="content">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <a href="/ujian/tema/levelid={{ $level->id }}/semesterId={{ Year::thisSemester()->id }}/periodId={{ $scoreratio->id }}/themeId={{ $themesubject->id }}/createTest" class="btn btn-primary">Tambah Soal</a>
                </div>
                <div class="col-sm-6">
                    <a href="/ujian/tema/levelid={{ $level->id }}" class="btn btn-link float-right">
